...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xDB478000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xDB47C000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xDCBF4B18)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Name (MBB, 0xE0000000)
            Name (MBL, 0x1D000000)
            Name (MAB, 0x0000001020000000)
            Name (MAL, 0x0000006FE0000000)
